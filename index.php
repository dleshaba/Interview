                                    ...
                                    <div class="panel-body">
                                        <form action="add_task.php" method="POST" role="form">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="5" name="description" required placeholder="Task description"></textarea>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <label class="col-md-4">Due Date</label>
                                                    <div class="input-group col-md-8">
                                                        <input type="text" class="form-control date-input" name="due_date" placeholder="mm/dd/yyyy" id="datepicker" required>
